...
params = yaml.safe_load(open('C:/Users/Gilles/Documents/GitHub/my_own_dvc_test/params.yaml'))['compare_data']
os.makedirs(os.path.join('data', 'compared'), exist_ok=True)
...
def compare_data(file_name_init,file_name_mod,params):
    ...
    np.savetxt("data/compared/data_diff.txt",np.transpose(np.array([x_init,diff])),delimiter=',');
    return y_mod
...
if __name__ == '__main__':
    ...
    compare_data(file_name_init,file_name_mod,params)
    print('End of main')